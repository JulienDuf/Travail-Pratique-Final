			...
			*/
			...
			if (_pVecteurGrenade->ObtenirComposanteX() >= 0) {
				...
				*_boSensRotation = true;
				...
				// Boucle qui vÈrifie les pixels du cÙtÈ droit du rect...
			...
			else
			{
				...
				*_boSensRotation = false;
				...
				// Boucle qui vÈrifie les pixels du cÙtÈ gauche du rect...
				for (int j = 0; j < _pSurfaceGrenade->h; j++) {
					iX = 0;
					iY = j;
					boArret = false;
			...
			if (_pVecteurGrenade->ObtenirComposanteY() >= 0) {
				...
				// Boucle qui vÈrifie les pixels du cÙtÈ bas du rect...
				for (int i = 0; i < _RectDestinationGrenade->w; i++) {
					iX = i;
			...
			else
			{
				...
				// Boucle qui vÈrifie les pixels du cÙtÈ haut du rect...
				for (int i = 0; i < _RectDestinationGrenade->w; i++) {
					iX = i;
					iY = 0;
					boArret = false;
