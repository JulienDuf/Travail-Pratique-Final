...
public:
	...
	void CreateGame(string _strEmplacementMap, int _iNombreÉquipe, int _iNombreJoueur, SDL_Surface* _pSurfaceGabarie, CVent* _pVent,SDL_Renderer* _pRenderer) {

		m_pGame = new CGame(_strEmplacementMap, _iNombreÉquipe, _iNombreJoueur, _pSurfaceGabarie, _pVent, m_pSDLRenderer);
	}
